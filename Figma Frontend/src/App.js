...
function App1() {
  ...
  useEffect(()=>{
    if (location.pathname == "/" || location.pathname == "/SignUp" || location.pathname == "/ForgetPass" || location.pathname == "/Profile" || location.pathname == "/ResetPassword") {
      setHideNavBar(true)
    }
    else{
      setHideNavBar(false)
  ...
  return(
    <div>
      ...
      {!HideNavBar && <NavBarLower></NavBarLower> }
      ...
      <Routes>
        ...
        <Route path='/ResetPassword/:email' element={<ResetPassword></ResetPassword>}></Route>
